...
# Модифицированная функция случайного блуждания для сохранения путей
...
# Параметры
n = 20
start_coords = (2, 7)  # Начальная точка (пример: верхний левый угол)
end_coords = (8, 17)  # Конечная точка (пример: нижний правый угол)
